...
xmesh,ymesh=np.meshgrid(np.linspace(0,1,300),np.linspace(0,1,300),indexing='ij')
...
point1=(0.1,0.5)
point2=(0.9,0.5)
sec_long=digdem.section.Section([point1,point2],'long',
                                 normalized=False,
                                 dinterp=0.05)
#sec_long.extreme_points_names=['a','b']
point1=(0.5,0.2)
point2=(0.5,0.8)
sec_trans=digdem.section.Section([point1,point2],'trans',
                                  normalized=False,
                                  dinterp=0.05)

#Create SurfMod

new_dem=digdem.surfmod.SurfMod(zold,
                               mask,
                               xaxis=xmesh[:,0],
                               yaxis=ymesh[0,:],
...
new_dem.plot(figsize=None,axe=None,contour_step=0.05,light_pos=[45,45],
             contour_properties={},section_properties={'lw':3},
             text_properties={},control_points_properties=None,
